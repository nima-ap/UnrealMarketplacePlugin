...
namespace PlayFab
{
    ...
    {
    public:
        DECLARE_DELEGATE_OneParam(FAcceptGroupApplicationDelegate, const GroupsModels::FEmptyResult&);
        DECLARE_DELEGATE_OneParam(FAcceptGroupInvitationDelegate, const GroupsModels::FEmptyResult&);
        DECLARE_DELEGATE_OneParam(FAddMembersDelegate, const GroupsModels::FEmptyResult&);
        DECLARE_DELEGATE_OneParam(FApplyToGroupDelegate, const GroupsModels::FApplyToGroupResponse&);
        DECLARE_DELEGATE_OneParam(FBlockEntityDelegate, const GroupsModels::FEmptyResult&);
        DECLARE_DELEGATE_OneParam(FChangeMemberRoleDelegate, const GroupsModels::FEmptyResult&);
        ...
        DECLARE_DELEGATE_OneParam(FDeleteGroupDelegate, const GroupsModels::FEmptyResult&);
        DECLARE_DELEGATE_OneParam(FDeleteRoleDelegate, const GroupsModels::FEmptyResult&);
        ...
        DECLARE_DELEGATE_OneParam(FRemoveGroupApplicationDelegate, const GroupsModels::FEmptyResult&);
        DECLARE_DELEGATE_OneParam(FRemoveGroupInvitationDelegate, const GroupsModels::FEmptyResult&);
        DECLARE_DELEGATE_OneParam(FRemoveMembersDelegate, const GroupsModels::FEmptyResult&);
        DECLARE_DELEGATE_OneParam(FUnblockEntityDelegate, const GroupsModels::FEmptyResult&);
