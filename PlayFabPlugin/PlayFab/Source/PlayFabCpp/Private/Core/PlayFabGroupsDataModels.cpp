...
PlayFab::GroupsModels::FEmptyResult::~FEmptyResult()
{

}

void PlayFab::GroupsModels::FEmptyResult::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::GroupsModels::FEmptyResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
void PlayFab::GroupsModels::writeEntityTypesEnumJSON(EntityTypes enumVal, JsonWriter& writer)
{
    switch (enumVal)
    {
...
GroupsModels::EntityTypes PlayFab::GroupsModels::readEntityTypesFromValue(const TSharedPtr<FJsonValue>& value)
{
    return readEntityTypesFromValue(value.IsValid() ? value->AsString() : "");
}

GroupsModels::EntityTypes PlayFab::GroupsModels::readEntityTypesFromValue(const FString& value)
{
