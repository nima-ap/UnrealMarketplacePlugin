...
void PlayFab::EventsModels::writeEntityTypesEnumJSON(EntityTypes enumVal, JsonWriter& writer)
{
    switch (enumVal)
    {
...
EventsModels::EntityTypes PlayFab::EventsModels::readEntityTypesFromValue(const TSharedPtr<FJsonValue>& value)
{
    return readEntityTypesFromValue(value.IsValid() ? value->AsString() : "");
}

EventsModels::EntityTypes PlayFab::EventsModels::readEntityTypesFromValue(const FString& value)
{
