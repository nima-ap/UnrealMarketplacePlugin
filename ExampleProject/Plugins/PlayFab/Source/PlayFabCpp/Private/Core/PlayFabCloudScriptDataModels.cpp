...
void PlayFab::CloudScriptModels::writeEntityTypesEnumJSON(EntityTypes enumVal, JsonWriter& writer)
{
    switch (enumVal)
    {
...
CloudScriptModels::EntityTypes PlayFab::CloudScriptModels::readEntityTypesFromValue(const TSharedPtr<FJsonValue>& value)
{
    return readEntityTypesFromValue(value.IsValid() ? value->AsString() : "");
}

CloudScriptModels::EntityTypes PlayFab::CloudScriptModels::readEntityTypesFromValue(const FString& value)
{
