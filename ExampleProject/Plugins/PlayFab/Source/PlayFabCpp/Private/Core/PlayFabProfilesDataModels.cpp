...
void PlayFab::ProfilesModels::writeEntityTypesEnumJSON(EntityTypes enumVal, JsonWriter& writer)
{
    switch (enumVal)
    {
...
ProfilesModels::EntityTypes PlayFab::ProfilesModels::readEntityTypesFromValue(const TSharedPtr<FJsonValue>& value)
{
    return readEntityTypesFromValue(value.IsValid() ? value->AsString() : "");
}

ProfilesModels::EntityTypes PlayFab::ProfilesModels::readEntityTypesFromValue(const FString& value)
{
