...
void PlayFab::DataModels::writeEntityTypesEnumJSON(EntityTypes enumVal, JsonWriter& writer)
{
    switch (enumVal)
    {
...
DataModels::EntityTypes PlayFab::DataModels::readEntityTypesFromValue(const TSharedPtr<FJsonValue>& value)
{
    return readEntityTypesFromValue(value.IsValid() ? value->AsString() : "");
}

DataModels::EntityTypes PlayFab::DataModels::readEntityTypesFromValue(const FString& value)
{
