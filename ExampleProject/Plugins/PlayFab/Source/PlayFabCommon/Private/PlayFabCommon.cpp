...
class FPlayFabCommonModule : public IPlayFabCommonModuleInterface
{
	...
	bool GetUseDevelopmentEnvironment() const override { return PlayFabCommon::PlayFabCommonSettings::useDevelopmentEnvironment; }
	FString GetServerURL() const override { return PlayFabCommon::PlayFabCommonSettings::serverURL; }
	FString GetDevelopmentEnvironmentURL() const override { return PlayFabCommon::PlayFabCommonSettings::developmentEnvironmentURL; }
	...
	void SetUseDevelopmentEnvironment(bool useDevelopmentEnvironment) override { PlayFabCommon::PlayFabCommonSettings::useDevelopmentEnvironment = useDevelopmentEnvironment; }
	void SetServerURL(const FString& serverURL) override { PlayFabCommon::PlayFabCommonSettings::serverURL = serverURL; }
	void SetDevelopmentEnvironmentURL(const FString& developmentEnvironmentURL) override { PlayFabCommon::PlayFabCommonSettings::developmentEnvironmentURL = developmentEnvironmentURL; }
...
bool FPlayFabCommonModule::HandleSettingsSaved()
{
	...
	PlayFabCommon::PlayFabCommonSettings::useDevelopmentEnvironment = GetDefault<UPlayFabRuntimeSettings>()->bUseDevelopmentEnvironment;
	PlayFabCommon::PlayFabCommonSettings::developmentEnvironmentURL = GetDefault<UPlayFabRuntimeSettings>()->DevelopmentEnvironmentURL;
